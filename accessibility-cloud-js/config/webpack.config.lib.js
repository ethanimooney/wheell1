...
if (env.stringified['process.env'].NODE_ENV !== '"production"') {
  throw new Error('Library builds must have NODE_ENV=production.');
}
...
if (extract) {
  ...
  c3po.extract = { output: 'src/i18n/translations.pot' };
}
